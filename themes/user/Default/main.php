...
<section class="last_recipes_section">
    ...
    <div class="last_recipes_main">
        <div class="recipe flex">
            <div class="recipe_image"><img src="<?php echo ABSPATH ?>public/img/buleczki.png" alt="buleczki"></div>
            <div class="recipe_data">
                <span class="recipe_date">4 styczeń, 2021</span>
                <h3 class="recipe_title">Maślane bułeczki do hot-dogów</h3>
            </div>
            <div class="more_button">Więcej</div>
        </div>
        <div class="recipe flex">
            <div class="recipe_image"><img src="<?php echo ABSPATH ?>public/img/buleczki.png" alt="buleczki"></div>
            <div class="recipe_data">
                <span class="recipe_date">12 styczeń, 2021</span>
                <h3 class="recipe_title">Gruzińskie pierogi chinkali</h3>
            </div>
            <div class="more_button">Więcej</div>
        </div>
    </div>
