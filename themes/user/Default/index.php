...
<html>
    ...
    <body>
        ...
        <main>
                ...
                <section class="best_recipes_section">
                    ...
                    <div class="social_media_container">
                        <div class="social_media">
                            <img src="<?php echo ABSPATH ?>themes/user/Default/img/instagram-icon.png" alt="instagram-icon">
                        </div>
                        <div class="social_media">
                            <img src="<?php echo ABSPATH ?>themes/user/Default/img/facebook-icon.png" alt="facebook-icon">
                        </div>
                    </div>
                </section>
                <section class="worlds_cuisines_section flex">
                    <div class="left_arrow arrow" id="prevBtn"><img src="<?php echo ABSPATH ?>themes/user/Default/img/arrow2-icon.svg" alt="DOZMIANY"></div>
            ...
            <div class="right_arrow arrow" id="nextBtn"><img src="<?php echo ABSPATH ?>themes/user/Default/img/arrow2-icon.svg" alt="DOZMIANY"></div>
            </section>
